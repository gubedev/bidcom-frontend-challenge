  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center gap-4 h-16">
        ...
        <button
          className="flex flex-col justify-center gap-1.5 lg:hidden flex-shrink-0"
        ...
        <div className="flex items-center gap-4 ml-auto sm:ml-0 flex-shrink-0">
          ...
          <div className="hidden lg:flex flex-col text-white text-xs leading-tight">
            <a
              href="https://api.whatsapp.com/send?phone=5491168652233&text=Hola, quería consultar acerca de"
              target="_blank"
            ...
            <a href="tel:08001121102" className="flex items-center gap-1 hover:underline">
          ...
          <Link
            href="#"
            className="relative flex items-center justify-center text-white hover:opacity-80 transition-opacity"
            aria-label="Carrito"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
